...
# # Percentile Drops
# fivePercentDrop = function(triggerType, marketingYear, row){
...
#     if (percentile == 60){
#       #55
#       fifty = which(names(marketingYear) == "Baseline")
#       sixty = which(names(marketingYear) == "60th")
#       fiftyFive = rowMeans(marketingYear[row, fifty:sixty])
#       if(price <= fiftyFive){
#         return(TRUE)
#       } else{
#         return(FALSE)
...
#       #65
#       sixty = which(names(marketingYear) == "60th")
#       seventy = which(names(marketingYear) == "70th")
#       sixtyFive = rowMeans(marketingYear[row, sixty:seventy])
#       if(price <= sixtyFive){
#         return(TRUE)
#       }  else{
#         return(FALSE)
...
#       #75
#       seventy = which(names(marketingYear) == "70th")
#       eighty = which(names(marketingYear) == "80th")
#       seventyFive = rowMeans(marketingYear[row, seventy:eighty])
#       if(price <= seventyFive){
#         return(TRUE)
#       }  else{
#         return(FALSE)
#       }
...
#       #85
#       eighty = which(names(marketingYear) == "80th")
#       ninety = which(names(marketingYear) == "90th")
#       eightyFive = rowMeans(marketingYear[row, eighty:ninety])
#       if(price <= eightyFive){
#         return(TRUE)
#       } else{
#         return(FALSE)
...
#       #92
#       ninety = which(names(marketingYear) == "90th")
#       ninetyFive = which(names(marketingYear) == "95th")
#       ninetyTwo = rowMeans(marketingYear[row, ninety:ninetyFive])
#       if(price <= ninetyTwo){
#         return(TRUE)
#       } else{
#         return(FALSE)
                ...
                if(dim(trailingStopActualized)[1] != 0) {
                  ...
                  if(triggers$Date[tRow] %within% interval1 && triggers$Type[tRow] != "Ten Day High" && triggers$Type[tRow] != "All Time High" && triggers$Type[tRow] != "Seasonal") {
                    ...
                    if(!(triggers$Previous.Percentile[tRow] %in% trailingStopActualized$Previous.Percentile[tempRows])) {
                      if(fivePercentDrop(triggers$Type[tRow], marketingYear, row)){
