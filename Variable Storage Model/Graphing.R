...
if (type == "corn") {
  for (i in 1:length(Corn_CropYearObjects)) {
    for (j in 1:length(Corn_CropYearObjects[[i]])) {
      
      
      POTitle = "Price Objective w/o Multi-Year"
      Corn_CropYearObjects[[i]][[j]]$POPlot = plotMarketingYear(Corn_CropYearObjects[[i]][[j]]$`Crop Year`,
                                                                mdy(Corn_CropYearObjects[[i]][[j]]$`Start Date`),
                                                                mdy(Corn_CropYearObjects[[i]][[j]]$`Stop Date`),
                                                                Corn_CropYearObjects[[i]][[j]]$`Marketing Year`,
                                                                Corn_CropYearObjects[[i]][[j]]$`PO Actualized`,
                                                                POTitle)
      
      POMYTitle = "Price Objective with Multi-Year"
      names(Corn_CropYearObjects[[i]][[j]]$`Marketing Year MY`) = names(Corn_CropYearObjects[[i]][[j]]$`Marketing Year`)
      Corn_CropYearObjects[[i]][[j]]$POMYPlot = plotMarketingYear(Corn_CropYearObjects[[i]][[j]]$`Crop Year`,
                                                                  mdy(Corn_CropYearObjects[[i]][[j]]$`Start Date`),
                                                                  mdy(Corn_CropYearObjects[[i]][[j]]$`Stop Date`),
                                                                  Corn_CropYearObjects[[i]][[j]]$`Marketing Year`,
                                                                  Corn_CropYearObjects[[i]][[j]]$`PO Actualized MY`,
                                                                  POMYTitle)
      
      TSTitle = "Trailing Stop w/o Multi-Year"
      Corn_CropYearObjects[[i]][[j]]$TSPlot = plotMarketingYear(Corn_CropYearObjects[[i]][[j]]$`Crop Year`,
                                                                mdy(Corn_CropYearObjects[[i]][[j]]$`Start Date`),
                                                                mdy(Corn_CropYearObjects[[i]][[j]]$`Stop Date`),
                                                                Corn_CropYearObjects[[i]][[j]]$`Marketing Year`,
                                                                Corn_CropYearObjects[[i]][[j]]$`TS Actualized`,
                                                                TSTitle)
      TSMYTitle = "Trailing Stop with Multi-Year"
      Corn_CropYearObjects[[i]][[j]]$TSMYPlot = plotMarketingYear(Corn_CropYearObjects[[i]][[j]]$`Crop Year`,
                                                                  mdy(Corn_CropYearObjects[[i]][[j]]$`Start Date`),
                                                                  mdy(Corn_CropYearObjects[[i]][[j]]$`Stop Date`),
                                                                  Corn_CropYearObjects[[i]][[j]]$`Marketing Year`,
                                                                  Corn_CropYearObjects[[i]][[j]]$`TS Actualized MY`,
                                                                  TSMYTitle)
      
      SSTitle = "Seasonal Sales w/o Multi-Year"
      Corn_CropYearObjects[[i]][[j]]$SSPlot = plotMarketingYear(Corn_CropYearObjects[[i]][[j]]$`Crop Year`,
                                                                mdy(Corn_CropYearObjects[[i]][[j]]$`Start Date`),
                                                                mdy(Corn_CropYearObjects[[i]][[j]]$`Stop Date`),
                                                                Corn_CropYearObjects[[i]][[j]]$`Marketing Year`,
                                                                Corn_CropYearObjects[[i]][[j]]$`SS Actualized`,
                                                                SSTitle)
      
      SSMYTitle = "Seasonal Sales with Multi-Year"
      Corn_CropYearObjects[[i]][[j]]$SSMYPlot = plotMarketingYear(Corn_CropYearObjects[[i]][[j]]$`Crop Year`,
                                                                  mdy(Corn_CropYearObjects[[i]][[j]]$`Start Date`),
                                                                  mdy(Corn_CropYearObjects[[i]][[j]]$`Stop Date`),
                                                                  Corn_CropYearObjects[[i]][[j]]$`Marketing Year`,
                                                                  Corn_CropYearObjects[[i]][[j]]$`SS Actualized MY`,
                                                                  SSMYTitle)
    }
  }
}
