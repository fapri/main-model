...
cornBasis = read_csv("Miscellaneous/Basis/KStateCornMerged.csv")
citiesCounties = read_excel("Miscellaneous/Basis/Cities and Counties.xlsx")
kLocBasisMergeCorn = readRDS("Miscellaneous/Basis/KLocBasisMergeCorn.rds")

# Load data saved from the other basis script
Load_Data = function() {
  filePath = choose.files(default = paste0(getwd(), "/Miscellaneous/Basis/Distances/*.rds"), caption = "Select RDS Distance File:",
