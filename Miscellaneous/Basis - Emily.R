...
#            scale_colour_manual(values = c("#00BFC4", "#F8766D", "#7CAE00", "#C77CFF")))
#   
...
#            scale_colour_manual(values = c("#00BFC4", "#C77CFF", "#F8766D", "#7CAE00")))
#   
...
#            scale_colour_manual(values = c("#00BFC4", "#7CAE00", "#C77CFF", "#F8766D")))
#   
